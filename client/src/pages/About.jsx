...
const About = () => {
    return (
        <div className="card">
            ...
            <p className="textGeneral">
                <span className="fireText">Smoke </span> is an interactive social network designed to proprel intellectual property easily and efficiently to peers and fellow creatives for review, general sharing purposes and healthy, encouraging critque.
            </p>
            <p className='textGeneral'>
